...
<head>
    ...
    <title>국민보험공단 회원가입</title>
</head>
<body>
    <div id="wrap">
        <form name="signup_form" id="signupForm" method="post" action="">
            <table>
                <tbody>
                    <tr>
                        <th>사업장관리번호</th>
                        <td><input name="gr_num" id="grNum" type="text"><button>사업장 관리번호 확인방법</button></td>
                    </tr>
                    <tr>
                        <th>사업장기호</th>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="form_email">
                                <span>
                                    <input class="input_email1" name="input_email" id="inputEmail" type="text">
                                </span>
                                <em> @ </em>
                                <span>
                                    <input class="input_email2" name="input_email" id="inputEmail" type="text">
                                </span>
                                <span>
