                            ...
                            <div className="content">  
                                        ...
                                        <div>
                                            ...
                                            <div className="sub">
                                                <ul>
                                                    ...
                                                    <li>
                                                        <label>
                                                            <input type="checkbox" name='category1_chk4' id='category1Chk4' value={'샐러드 간편식'}/>
                                                            국·반찬·메인요리
                                                        </label>
                                                    </li>
                                                    <li>
                                                        <label>
                                                            <input type="checkbox" name='category1_chk5' id='category1Chk5' value={'샐러드 간편식'}/>
                                                            국·반찬·메인요리
                                                        </label>
                                                    </li>
                                                    <li>
                                                    ...
                                                    <li>
                                                        <label>
                                                            <input type="checkbox" name='category1_chk7' id='category1Chk7' value={'샐러드 간편식'}/>
                                                            국·반찬·메인요리
                                                        </label>
                                                    </li>
                                                    <li>
                                                        <label>
                                                            <input type="checkbox" name='category1_chk8' id='category1Chk8' value={'샐러드 간편식'}/>
                                                            국·반찬·메인요리
                                                        </label>
                                                    </li>
                                                    <li>
                                                        <label>
                                                            <input type="checkbox" name='category1_chk9' id='category1Chk9' value={'샐러드 간편식'}/>
                                                            국·반찬·메인요리
                                                        </label>
                                                    </li>
                                                    <li>
                                                        <label>
                                                            <input type="checkbox" name='category1_chk10' id='category1Chk10' value={'샐러드 간편식'}/>
                                                            국·반찬·메인요리
                                                        </label>
                                                    </li>
                                                    <li>
                                            ...
                                            <div className="sub">
                                                <ul>
                                                    ...
                                                    <li>
                                                        <label>
                                                            <input type="checkbox" name='category2_chk3' id='category2Chk3' value={'국·반찬·메인요리'}/>
                                                            국·반찬·메인요리
                                                        </label>
                                                    </li>
                                                    <li>
                                                        <label>
                                                            <input type="checkbox" name='category2_chk4' id='category2Chk4' value={'샐러드 간편식'}/>
                                                            국·반찬·메인요리
                                                        </label>
                                                    </li>
                                                    <li>
                                                        <label>
                                                            <input type="checkbox" name='category2_chk5' id='category2Chk5' value={'샐러드 간편식'}/>
                                                            국·반찬·메인요리
                                                        </label>
                                                    </li>
                                                    <li>
                                                        <label>
                                                            <input type="checkbox" name='category2_chk6' id='category2Chk6' value={'샐러드 간편식'}/>
                                                            국·반찬·메인요리
                                                        </label>
                                                    </li>
                                                    <li>
                                                        <label>
                                                            <input type="checkbox" name='category2_chk7' id='category2Chk7' value={'샐러드 간편식'}/>
                                                            국·반찬·메인요리
                                                        </label>
                                                    </li>
                                                    <li>
                                                        <label>
                                                            <input type="checkbox" name='category2_chk8' id='category1Chk1' value={'샐러드 간편식'}/>
                                                            국·반찬·메인요리
                                                        </label>
                                                    </li>
                                                    <li>
                                ...
                                <div className="right">
                                    <div className="right-title">
                                        ...
                                        <span>
                                            <a href="!#" className='order-btn'><span>추천순</span><img src="./images/sub1/icon_qut.svg" alt="" /></a>
                                            <i>|</i>
