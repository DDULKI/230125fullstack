public class J02_2차원배열 {
    public static void main(String[] args) {
        // 1차원 배열 : 행(줄 로우 Row) a[행] 
        // 2차원 배열 : 행(줄 로우 Row), 열(칸 컬럼 Column) a[행][열]

        // 1차원 배열을 여러개
        int[] arr1 = {1,2,3,4,5};  //글번호 1칸
        String[] arr2 = {"글제목1","글제목2","글제목3","글제목4","글제목5"}; //글제목 2칸
        String[] arr3 = {"2023-01-01","2023-01-02","2023-01-03","2023-01-04","2023-01-05"}; //날짜 3칸
        int[] arr4 = {11,22,13,34,65}; //조회수 4칸
        ...
        System.out.println( );
        System.out.println( "2차원 배열 처리 게시판 반복문 출력 =======================================" );
        ...
        String[][] board = {
            ...
            {"4", "글제목4", "2023-01-04", "34"},
            {"5", "글제목5", "2023-01-05", "65"}    
        };

        // 2차원 배열 출력
        for(int i=0; i<board.length; i++){ // 행 5행
            for(int j=0; j<board[i].length; j++){ //열 4칸
