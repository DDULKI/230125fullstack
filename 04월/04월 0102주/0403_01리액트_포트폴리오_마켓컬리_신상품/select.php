<?
    ...
    // http://ddulki4994.dothome.co.kr/signup_db/select.php
    // CORS
    ...
    // 데이터 조회 SELECT 필드, 필드... FROM 테이블이블 
    // 데이터 조회 SELECT * FROM 테이블이블 
    // 구조적인 질의 언어 
    ...
    // 이스케이프 문자 유니코드 문자 사용안함 JSON_UNESCAPED_UNICODE
