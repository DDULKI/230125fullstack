...
<head>
    ...
    <style>
        *{margin:0; padding:0; vertical-align: middle;box-sizing: border-box;}
        ...
        #wrap #main #section5{ width: 100%; height:100vh; background: #c99; display: flex; align-items: center;justify-content: center; color: #fff;font-size: 100px; text-transform: uppercase;}
...
<body>
    ...
    <jsp:include page="./header.jsp" flush="fasle"/>
    <jsp:include page="<%= selectPage %>" flush="fasle"/>
    <jsp:include page="./footer.jsp" flush="fasle"/>
