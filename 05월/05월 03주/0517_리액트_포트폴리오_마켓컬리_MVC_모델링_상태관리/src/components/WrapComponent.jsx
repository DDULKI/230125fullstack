...
// 로그인 페이지 
// 아이디 찾기 페이지 - 이름, 휴대폰 탭 / 이름, 이메일 탭
// 찾은페이지결과 페이지  
// 비밀번호찾기페이지 - 이름, 휴대폰 탭 / 이름, 이메일 탭 
// 비밀번호새로설정페이지 
// BBS 
// 공지사항
// 1:1문의 
                ...
                <BrowserRouter>
                    <Routes>
                        <Route path='/' element={<HeaderComponent mapText={state.mapText} isMap={state.isMap} />}>
                            ...
                            <Route path='/회원가입폼' element={<SignUpComponent mapAddressFn={mapAddressFn} timer={state} timerCounterfn={timerCounterfn} />}/>
                        </Route>
                    </Routes>
                </BrowserRouter>
