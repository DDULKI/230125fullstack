...
public class J04_예외처리_닉네임 {
    ...
    public static void main(String[] args) {
        // 포함할 수 없는 닉네임 
        String[] nickName ={"사라님", "왕자님", "구름", "나그네", "연규진"};
        String nick = "";
        ...
        // try { 
        //     System.out.println("닉네임1 입력");
        //     nick = sc.nextLine();

        //     System.out.println("닉네임2 입력");
        //     nick = sc.nextLine();

        //     if(nick.length() >=3 && nick.length() <=16){
        //         throw new Exception("닉네임은 3~16자 이내로 작성해야합니다. ");
    ...
    while(true){
        try {
            ...
            for(int i=0; i<nickName.length; i++){
                ...
                // euqals()
                System.out.println("euqals() " + nickName[i].equals(nick));
