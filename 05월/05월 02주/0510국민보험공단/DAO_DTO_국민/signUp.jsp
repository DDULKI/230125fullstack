...
<body>
    <div id="wrap">
        <form name="signup_form" id="signupForm" method="post" action="./signUp_insert_action.jsp">
            <table>
                <tbody>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <span>
                                ...
                                <input name="sosic_ok" id="sosicOk" value="N" checked="checked" type="radio"><label for="infoYn2">안받음 (공단의 다양한 소식을 무료로 만나보세요)</label>
                            </span>
                        </td>
                    </tr>
                </tbody>
