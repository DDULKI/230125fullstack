                                ...
                                <ul>
                                    ...
                                    <li>
                                        <label for="">추가 입력사항<br>
                                            <input class="radio" type="radio" name="user_add" id="add" value="친구초대 추천인 아이디">친구초대 추천인 아이디
                                            <input class="radio" type="radio" name="user_add" id="add" value="참여 이벤트명">참여 이벤트명<br>
                                        </label>
                                    </li> 
                                    <li>
                                        <label for="">이용약관동의<br>
                                            <input class="chk1" type="checkbox" name="user_chk1" id="chk1" value="이용약관동의">이용약관동의
                                            <input class="chk1" type="checkbox" name="user_chk2" id="chk2" value="개인정보 수집∙이용 동의">개인정보 수집∙이용 동의<br>
                                            <input class="chk1" type="checkbox" name="user_chk3" id="chk3" value="무료배송, 할인쿠폰 등 혜택/정보 수신 동의">무료배송, 할인쿠폰 등 혜택/정보 수신 동의<br>
                                            <input class="chk1" type="checkbox" name="user_chk4" id="chk4" value="본인은 만 14세 이상입니다.">본인은 만 14세 이상입니다.<br>
                                        </label>
                                    </li>
                                    <li>
