...
<body>
    <div id="wrap">
        ...
        <%
            ...
            SignUpDTO signUpDTO = signUpDAO.getJoin(loginId);
        %>
                            ...
                            <div class="form_email">
                                ...
                                <span>
                                    <select name="email_domain_select" id="emailDomainSelect">
                                        ...
                                        <option <% if(signUpDTO.getEmail_domain_select().equals("naver.com")){%>checked="checked"<%}%> value="naver.com">네이버</option>
                                        <option <% if(signUpDTO.getEmail_domain_select().equals("nate.com")){%>checked="checked"<%}%> value="nate.com">네이트</option>
                                        <option <% if(signUpDTO.getEmail_domain_select().equals("daum.net")){%>checked="checked"<%}%>value="daum.net">다음(한메일)</option>
                                        <option <% if(signUpDTO.getEmail_domain_select().equals("yahoo.co.kr")){%>checked="checked"<%}%>value="yahoo.co.kr">야후</option>
                                        <option <% if(signUpDTO.getEmail_domain_select().equals("hotmail.com")){%>checked="checked"<%}%>value="hotmail.com">핫메일(MSN)</option>
                                        <option <% if(signUpDTO.getEmail_domain_select().equals("gmail.com")){%>checked="checked"<%}%>value="gmail.com">Gmail</option>
                                    </select>
                                </span>
                            </div>
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            <span>
                                ...
                                <input name="sosic_ok" id="sosicOk" value="NO"  type="radio" <% if(signUpDTO.getSosic_ok().equals("NO")){ %>checked="checked"<%}%>>
