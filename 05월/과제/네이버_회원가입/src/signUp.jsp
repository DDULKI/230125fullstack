...
<body>
    ...
    <div id="wrap">
        ...
        <form name="sign_up" id="signUp" method="post" action="member_write_dto.jsp">
            ...
            <span>
                <div class="birth">
                    <input class="year" type="text" name="birthYear" id="birthYear" placeholder="년(4자)">
                </div>
                <div class="birth">
                ...
                <div class="birth">
                    <input class="day" type="text" name="birthDay" id="birthDay" placeholder="일">
                </div>
            </span>
