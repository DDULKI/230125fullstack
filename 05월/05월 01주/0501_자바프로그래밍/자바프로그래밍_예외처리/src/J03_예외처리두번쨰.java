...
public class J03_예외처리두번쨰 {
    ...
    public static void main(String[] args) {
        ...
        try{
        ...
        catch(ArithmeticException e){ // 정수를 0으로 나눌수없다는 에러 메시지 
            System.out.println(" ArithmeticException 정수를 0으로 나눌 수 없습니다.");
            e.printStackTrace(); // 에러의 발생 위치를 출력 
            // e.toString();        // 간단한 문장출력 
        }
        catch(InputMismatchException e){ // 입력이 문제가 있을 때, 
            ...
            System.err.println("객체가 참조하고자하는 값이 없습니다. ");
            e.printStackTrace(); // 에러의 발생 위치를 출력 
        }
        finally{
            System.out.println("finally 예외와 관계없이 무조건 출력되는 내용입니다. ");
