...
export default function SignInIdSearchComponent() {
    ...
    React.useEffect(()=>{
        ...
        (userId!=='' && userEmail!=='') ? setIsBtn2(true): setIsBtn2(false);

    },[userId,userId2,userHp,userEmail]);
                                        ...
                                        <>
                                            ...
                                            <li>
                                                <input 
                                                    ...
                                                    ref={userIdRef}
                                                />
                                                {userId!=='' && <a onClick={(e)=>onClickIconDel(e,'userId')} href="!#"><img src="./images/sign_in/icon_x.svg" alt="" /></a>}
                                            </li>
                                        ...
                                        <>
                                            ...
                                            <li>
                                                <input 
                                                    ...
                                                    ref={userId2Ref}
                                                />
                                                {userId2!==''&&<a onClick={(e)=>onClickIconDel(e,'userId2')} href="!#"><img src="./images/sign_in/icon_x.svg" alt="" /></a>}
                                            </li>
