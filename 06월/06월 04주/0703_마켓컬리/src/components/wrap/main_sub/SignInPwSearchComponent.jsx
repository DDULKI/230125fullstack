...
export default function SignInPwSearchComponent () {
    ...
    const {confirmModalOpen, confirmMsg,isConfirmModal} = React.useContext(ConfirmContext);
    ...
    React.useEffect(()=>{
        ...
        const timerCount=()=>{
            ...
            if(nowTime >= startTime){ // 시작시간보다 현재 시간이 이상이면 종료 
                clearInterval(setId);
                setMinutes(0);
                setSeconds(0);
    ...
    const onClickHpAuth=(e)=>{
        ...
        confirmModalOpen(`인증번호가 발송되었습니다. 3분 안에 인증번호를 입력해 주세요. ${authNum}`)
    }
                                    ...
                                    (
                                        <>
                                            ...
                                            <li>
                                                ...
                                                ref={userIdRef} 
                                                />
                                                {userId!=='' && <a onClick={(e)=>onClickIconDel(e, 'userId')} href="!#"><img src="./images/sigin_in/icon_del.svg" alt="" /></a>}
                                            </li>
                                            ...
                                            isAuth && (<>
                                                ...
                                                <li>
                                                        ...
                                                        <span>
                                                            ...
                                                            <i>:</i>
                                                            <em>{seconds<10 ? `${seconds}`:seconds}</em>
                                                        </span>
                                                </li>
                                            </>)
                                        }
