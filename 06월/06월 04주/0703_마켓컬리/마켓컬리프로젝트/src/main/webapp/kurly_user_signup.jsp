...
<div id="wrap">
    <section id="signup">
        <div class="container">
            ...
            <div class="content">
                <form autocapitalize="off" name="sign_Up" id="signUp" method="post" action="./kurly_user_signup_action.jsp">
                    <ul>
                        ...
                        <li><input maxlength="30"  autofocus required type="text"       name="user_irum"   id="userIrum"   placeholder="이름 입력하세요."></li>
                        <li><input maxlength="250" autofocus required type="email"      name="user_email"  id="userEmail"  placeholder="이메일을를 입력하세요."></li>
                        <li><input maxlength="13"  autofocus required type="text"       name="user_hp"     id="userHp"     placeholder="연락처를 입력하세요."></li>
