...
import viewProductImg from './img/product/004ee48d-c745-4c58-b37f-f67a8f23b01f.jpg';
                        ...
                        <div className="right">
                            ...
                            <div className="bottom">
                                <div className="total-calc">
                                    <h2>총 상품금액 : <strong>9,440</strong><em>원</em></h2>
