...
export default function CartComponent({confirmModalOpen}) {
    ...
    const [isButtonSUB, setIsButtonSUB] = React.useState(true);
    const [isLogin, setLogin] = React.useState(false); // 로그인상태 true, 로그인안한상태 false
    ...
    const onClickSub=(e, record)=>{
        ...
        // 비교문 다음 해당하지 않는 데이터는 그대로의 값으로 리턴한다. 
        // 해당하는 제품은 수량 수정, 금액수정 리턴 
                                ...
                                <li>
                                    <div>
                                        <div className="row1">
                                            ...
                                            <p>
                                                <strong>상품할인금액</strong><strong>{isLogin===false ? `-${Number(상품할인금액).toLocaleString('ko-KR')}` : 0}원</strong>
