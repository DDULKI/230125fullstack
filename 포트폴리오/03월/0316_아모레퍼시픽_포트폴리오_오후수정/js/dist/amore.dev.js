...
(function ($, window, document) {
  var amore = {
    ...
    header: function header() {// 메인버튼 클릭 이벤트 : 스무스 스크롤링 이벤트 구현 
    },
    section1: function section1() {
      var $slide = $('#section1 .slide');
      var $arrowNextBtn = $('#section1 .arrow-next-btn');
      var $arrowPrevBtn = $('#section1 .arrow-prev-btn');
      var $pageBtn = $('#section1 .page-btn');
      var cnt = 0;
      var setId = 0;
      var imsi = null; // 1-1. 메인슬라이드 함수 
      ...
      function mainNextSlide() {
        ...
        $slide.eq(imsi !== null ? imsi : cnt === 0 ? 2 : cnt - 1).css({
          zIndex: 2
        }); // 현재슬라이드 
      ...
      function mainPrevSlide() {
        ...
        $slide.eq(imsi !== null ? imsi : cnt === 2 ? 0 : cnt + 1).css({
          zIndex: 3
        }).stop().animate({
          opacity: 1
        }, 0).animate({
    ...
    section2: function section2() {
      // 패럴럭스 구현
      // 섹션1의 탑값이 200px 아래로 이동시 애니메이션 동작 
      var sec1Top = $('#section1').offset().top + 300; // 스크롤이벤트
    ...
    section3: function section3() {},
    section4: function section4() {},
...
//# sourceMappingURL=amore.dev.js.map
