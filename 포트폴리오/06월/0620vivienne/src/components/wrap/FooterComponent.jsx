...
export default function FooterComponent(){
    ...
    function InstagramLogo() {
        const logoUrl = useLogoUrl('https://www.instagram.com/static/images/ico/favicon-192.png/68d99ba29cc8.png');
      
        return (
          <img src={logoUrl} alt="Instagram Logo" />
        );
      }
      
      function FacebookLogo() {
        const logoUrl = useLogoUrl('https://www.facebook.com/images/fb_icon_325x325.png');
      
        return (
          <img src={logoUrl} alt="Facebook Logo" />
        );
      }
