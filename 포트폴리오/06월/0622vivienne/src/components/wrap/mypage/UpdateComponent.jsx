...
export default function UpdateComponent () {
        ...
        $.ajax({
            ...
            success(res) {
                ...
                setState({
                    ...
                    이메일 : res.result.이메일,
                    이름: res.result.이름,
                    비밀번호변경: res.result.비밀번호변경==="null"?'':res.result.비밀번호변경,
                    성별:res.result.성별,
                    휴대폰:res.result.휴대폰,
                    약관: res.result.약관,
    ...
    const onSubmitUpdate =(e)=>{
        ...
        $.ajax({
            url: 'http://localhost:8080/JSP/vivienne/update_action.jsp',
            type: 'POST',
            data:formData,
            success(res){
                console.log('AJAX 성공!');
            ...
            <div className="gap">
                ...
                <div className="content">
                    <form name='update_form' id='updateForm' action="" onSubmit={onSubmitUpdate}>
                        ...
                        <div className="join">
                            <label className='label_name'>비밀번호변경<i>*</i></label>
                            <input 
                                type="password" 
                                className='pw_input1' 
                                id='userPw' 
                        ...
                        <div className="button-box">
                            <button className='hp-num-btn' type='submit' onClick={onClickSubmit}>확인</button>
