...
public class UserDAO {
    ...
    public int signup(UserDTO userDTO){
        String SQL = "INSERT INTO vivienne_member(user_email, user_name, user_pw,user_gender,user_hp,user_jbss,user_birth,user_service) VELUES(?,?,?,?,?,?,?,?)";
        try{
            ps = conn.prepareStatement(SQL);
            ps.setString(1, userDTO.getUser_email());
            ps.setString(2, userDTO.getUser_name());
            ps.setString(3, userDTO.getUser_pw1()+userDTO.getUser_pw2());
            ps.setString(4, userDTO.getUser_gender());
            ps.setString(5, userDTO.getUser_hp()+userDTO.getUser_hp_ok());
            ps.setString(6, userDTO.getUser_jbss());
            ps.setString(7, userDTO.getUser_birth());
            ps.setString(8, userDTO.getUser_service());
    ...
    public int update(UserDTO userDTO){
        String SQL = "UPDATE vivienne_member SET user_name=? user_pw=?, user_gender=?, user_hp=?, user_jbss=?, user_birth=? WHERE user_email=?";
        try {
            ps = conn.prepareStatement(SQL);
            ps.setString(1, userDTO.getUser_name());
            ps.setString(2, userDTO.getUser_pw1()+userDTO.getUser_pw2());
            ps.setString(3, userDTO.getUser_gender());
            ps.setString(4, userDTO.getUser_hp());
            ps.setString(5, userDTO.getUser_jbss());
