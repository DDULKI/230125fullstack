                ...
                if (btnNumber===0) { // ALL - 8개
                    ...
                    switch(cols){  // 변수 cols가
                        case 4:    // 4인경우
                            ...
                            galleryBoxUlLi.eq(5).stop().animate({top: imgH*1, left: imgW*2}, 300);
                            galleryBoxUlLi.eq(6).stop().animate({top: imgH*1, left: imgW*3}, 300);
                     ...
                     imgBox.eq(7).addClass('addZoom');
                         ...
                         imgBox. removeClass('addZoom'); // 줌효과 모두 초기화 삭제 
                                     ...
                                     // 스위치(조건) 케이스(case ~경우) 문
                                     switch(cols){  // 변수 cols가
                                         case 4:    // 4인경우  0 1 3 4 6 7 
                                             galleryBoxUlLi.eq(0).stop().animate({top: imgH*0, left: imgW*0}, 300);
                                             galleryBoxUlLi.eq(1).stop().animate({top: imgH*0, left: imgW*1}, 300);
                                             galleryBoxUlLi.eq(2).stop().animate({top: imgH*0, left: imgW*2}, 300);
                                             galleryBoxUlLi.eq(3).stop().animate({top: imgH*0, left: imgW*3}, 300);
                                             galleryBoxUlLi.eq(4).stop().animate({top: imgH*0, left: imgW*4}, 300);
                                         ...
                                         case 3:    // 3인경우
                                             galleryBoxUlLi.eq(0).stop().animate({top: imgH*0, left: imgW*0}, 300);
                                             galleryBoxUlLi.eq(1).stop().animate({top: imgH*0, left: imgW*1}, 300);
                                             galleryBoxUlLi.eq(3).stop().animate({top: imgH*1, left: imgW*2}, 300);   
                                         ...
                                         case 2:   // 2인경우
                                            galleryBoxUlLi.eq(0).stop().animate({top: imgH*0, left: imgW*0}, 300);
                                            galleryBoxUlLi.eq(1).stop().animate({top: imgH*1, left: imgW*1}, 300);
                                            galleryBoxUlLi.eq(3).stop().animate({top: imgH*1, left: imgW*2}, 300);   
                                         ...
                                         default:   // 1인경우 다른 모든것 그 밖에 else
                                            galleryBoxUlLi.eq(0).stop().animate({top: imgH*0, left: imgW*0}, 300);
                                            galleryBoxUlLi.eq(1).stop().animate({top: imgH*1, left: imgW*1}, 300);
                                            galleryBoxUlLi.eq(3).stop().animate({top: imgH*2, left: imgW*2}, 300);   

                                            galleryBoxUlLi.eq(4).stop().animate({top: imgH*3, left: imgW*0}, 300);
                                            galleryBoxUlLi.eq(6).stop().animate({top: imgH*4, left: imgW*1}, 300);
                                            galleryBoxUlLi.eq(7).stop().animate({top: imgH*5, left: imgW*2}, 300);    
                                            break;                      
                                     }
                                      // 줌인 (Zoom In) 효과
                                      // hide 2 5 
                    ...
                    // show 0246
                     ...
                     switch(cols){  // 변수 cols가
                         case 4:    // 4인경우
                             ...
                             galleryBoxUlLi.eq(4).stop().animate({top: imgH*1, left: imgW*3}, 300);
