...
export default function WrapComponent() {
    ...
    return (
        <div id='wrap'>
                <TopModalComponent/>
                <HeaderComponent isMap={state.isMap}/>
                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                <div className="sub-list">
                                                    ...
                                                    <a href="!#">
                                                        <span>자세히보기</span>
                                                        <img src="./images/popup/ico_arrow_down_11x10 (1).svg" alt="" />
                                                    </a>
                                                    <div className="sub">
