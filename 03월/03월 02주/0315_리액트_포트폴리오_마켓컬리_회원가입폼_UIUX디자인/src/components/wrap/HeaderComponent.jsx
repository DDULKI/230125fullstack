...
export default function HeaderComponent() {
    ...
    React.useEffect(()=>{
        // 헤더영역에 .row3의 위에서 .row3 offset().top 포지션 스크롤탑값이 도달시 
            ...
            <div className="container">
                <div className="gap">
                    <div className="content">
                        ...
                        <div className={`row2${state.isFixed?' on':''}`} > {/* 온 앞에 공백을 꼭 띄워줘라.  */}
                            <div className="container">
                                <div className="left">
                                    <h1>
