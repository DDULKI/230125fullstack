                                ...
                                <ul>
                                    ...
                                    <li>
                                        <div>
                                            ...
                                            <div className="center-box">
                                                <input type="email" name='user_email' id='userEmail' placeholder='예:seulki4994@kulry.com'/>
                                            </div>
                                            <button type='button'>중복확인</button>
                                        </div>
                                    </li> 
                                    ...
                                    <li>
                                        <div>
                                            ...
                                            <div className="center-box">
                                                ...
                                                {
                                                    state.isAddress1 && <button type='button'>주소 검색</button>
                                                }

                                                {   // 주소검색 완료 후 주소 입력된 입력 상자 
                                                    state.isAddress2 && (
                                                        <>
                                           ...
                                           {
                                                state.isAddress2 && (
                                                    <button type='button'><img src="./images/sign_up/ico_search2.svg" alt="" />재검색</button>
                                                )
                                            }
                                            ...
                                            <div className="center-box birth">
                                                <div className="birth-box">
                                                    <ul>
                                                        ...
                                                        <li><i>/</i></li>
                                                        <li><input type="text" maxLength={2} name='user_birth_month' id='userBirtMonth' placeholder='MM'/></li>
                                                        <li><i>/</i></li>
                                        ...
                                        <div>
                                            ...
                                            <div className="center-box service">
                                                ...
                                                <ul>
                                                    ...
                                                    <li>
                                                        <label><input type="checkbox" name='user_service1' id='userService1' value={'이용약관 동의'}/>이용약관 동의</label><span>(필수)</span>
                                                        
                                                    </li>
                                                    <li>
                                                        <label><input type="checkbox" name='user_service2' id='userService2' value={'개인정보 수집∙이용 동의 (필수)'}/>개인정보 수집∙이용 동의</label><span>(필수)</span>
                                                        
                                                    </li>
                                                    <li>
                                                        <label><input type="checkbox" name='user_service3' id='userService3' value={'개인정보 수집∙이용 동의 (선택)'}/>이용약관 동의</label><span>(선택)</span>
                                                       
                                                    </li>
                                                    <li>
                                                        <label><input type="checkbox" name='user_service4' id='userService4' value={'무료배송, 할인쿠폰 등 혜택/정보 수신 동의 (선택)'}/>무료배송, 할인쿠폰 등 혜택/정보 수신 동의</label><span>(선택)</span>
                                                        
                                                    </li>
                                                    <li className='service56'>
                                                        <label><input type="checkbox" name='user_service5' id='userService5' value={'SNS'}/>SNS</label>
                                                        <label><input type="checkbox" name='user_service6' id='userService6' value={'이메일'}/>이메일</label>
                                                        <h6>동의 시 한 달간 [5%적립] + [2만원 이상 무료배송] 첫 주문 후 안내</h6>

                                                    </li>
                                                    <li>
                                                        
                                                        <label><input type="checkbox" name='user_service7' id='userService7' value={'본인은 만 14세 이상입니다.'}/>본인은 만 14세 이상입니다.</label><span>(필수)</span>
...
SignUpComponent.defaultProps = {
    회원가입: {
        ...
        // 주소1:'', //string
        // 주소2:'', //string
        isAddress1: true, // Boolean 논리값 변수 
        isAddress2: false, // Boolean 논리값 변수 
