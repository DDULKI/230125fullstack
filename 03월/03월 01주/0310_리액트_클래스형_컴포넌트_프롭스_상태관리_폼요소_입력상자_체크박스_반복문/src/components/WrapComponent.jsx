                    ...
                    <div className="content">
                        <form name='member_form' id='memberForm' method='post' action="./member_form.php">
                            <ul>
                                ...
                                <li className='fruit'>
                                    { //JSX 스크립트는 세미콜론; 주의 SEMI COLONE....
                                        this.state.과일.map((item,idx)=>{
                                            return(
                                                //  {/* 템플릿 리터럴은 제일 먼저 양쪽에 수염괄호(중괄호) 를 해주고, 백틱으로 감싸준다.  */}
                                                //     {/* 중괄호안에 또 중괄호는 중괄호 앞에 달러 사인을 표기한다. 그럼 변수로 인식된다. */}
