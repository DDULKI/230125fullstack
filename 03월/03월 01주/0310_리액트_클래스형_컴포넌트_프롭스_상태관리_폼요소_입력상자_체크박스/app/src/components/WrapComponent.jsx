...
class WrapComponent extends Component {
    ...
    onChangeCheckEvent1=(e)=>{
        console.log(e.target.checked); // 체크드 선택이되면 true 선택을 해제하면 false로 결과 출력
        console.log(e.target.value);  // 무슨 과일을 체크(선택) 했니? 
        if(e.target.checked === true){

            this.setState({
                checked1: true, // true 를 써도 된다. true니까. 
                좋아하는과일: [ ...this.state.좋아하는과일, e.target.value ]
            })
         } 
         else { // false 딸기를 제외한 배열 재구성하는 필터 메서드 
            this.setState({
                checked1: false, // true 를 써도 된다. true니까. 
                // 좋아하는과일: this.state.좋아하는과일.filter((item)=>item!=='딸기') // 딸기를 제외한 나머지 값들을 나오게한다. 
    ...
    onChangeCheckEvent2=(e)=>{
        if(e.target.checked === true){
            ...
            this.setState({
                checked2: true, // true 를 써도 된다. true니까. 
                좋아하는과일: [ ...this.state.좋아하는과일, e.target.value ]
            })
        }
        else {
    ...
    onChangeCheckEvent3=(e)=>{
        if(e.target.checked === true){
            this.setState({
                checked3: true, // true 를 써도 된다. true니까. 
                좋아하는과일: [ ...this.state.좋아하는과일, e.target.value ]
            })
        }
        else{
    ...
    onChangeCheckEvent4=(e)=>{
        if(e.target.checked === true){
            this.setState({
                checked4: true, // true 를 써도 된다. true니까. 
                좋아하는과일: [ ...this.state.좋아하는과일, e.target.value ]
            })
        }
        else{
    ...
    onChangeCheckEvent5=(e)=>{
        if(e.target.checked === true){
            ...
            this.setState({
                checked5: true, // true 를 써도 된다. true니까. 
                좋아하는과일: [ ...this.state.좋아하는과일, e.target.value ]
            })
        }
        else{
    ...
    onChangeHobbyEvent1=(e)=>{
        if(e.target.hobby === true){
            this.setState({
                hobby1: true, 
                취미: [...this.state.취미, e.target.value]
            })
        }
        else{
            this.setState({
    ...
    onChangeHobbyEvent3=(e)=>{
        if(e.target.hoddy === true){
            this.setState({
                hobby3: true,
                취미: [...this.state.취미, e.target.value]
            })
                    ...
                    <div className="content">
                        <form name='member_form' id='memberForm' method='post' action="./member_form.php">
                            <ul>
                                ...
                                <li>
                                    <div>
                                        <label htmlFor="userId">이름<i>*</i></label>
                                        <input 
                                            type="text" 
                                            name='user_name' 
                                            id='userName' 
                                ...
                                <li>
                                    <div>
                                        ...
                                        <input 
                                            ...
                                            name='user_email' 
                                            id='userEmail' 
                                            placeholder='예:tmfrl4994@naver.com' 
                                ...
                                <li className='hobby'>
                                    <label htmlFor="hob1"><input onChange={this.onChangeHobbyEvent1} type="checkbox" name='hob1' id='hob1' value='영화' hobby={this.state.hobby1}/> 영화</label>
                                    <label htmlFor="hob2"><input onChange={this.onChangeHobbyEvent2} type="checkbox" name='hob2' id='hob2' value='요가' hobby={this.state.hobby2} /> 요가</label>
                                    <label htmlFor="hob3"><input onChange={this.onChangeHobbyEvent3} type="checkbox" name='hob3' id='hob3' value='악기연주' hobby={this.state.hobby3}/> 악기연주</label>
                                    <label htmlFor="hob4"><input onChange={this.onChangeHobbyEvent4} type="checkbox" name='hob4' id='hob4' value='공연보기' hobby={this.state.hobby4}/> 공연보기</label>
                                    <label htmlFor="hob5"><input onChange={this.onChangeHobbyEvent5} type="checkbox" name='hob5' id='hob5' value='책읽기' hobby={this.state.hobby5}/> 책읽기</label>
                                </li>
                            </ul>
