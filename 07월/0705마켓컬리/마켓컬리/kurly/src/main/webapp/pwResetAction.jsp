...
<%
		...
		int result = new userDAO().pwReset("123456789");
		
		if(result==-1){
%>
	
		<script>
			alert("비밀번호 재설정 실패했습니다. 입력값 확인하고 다시 시도하세요!")
			history.go(-1);
		<script/>
<%
		}	
...
%>
		<script>
			alert("비밀번호 재설정 성공:)★");
			location.href="./kurly_user_signin.sjp";
		<script/>
