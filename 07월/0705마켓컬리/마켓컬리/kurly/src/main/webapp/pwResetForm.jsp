		...
		<div class="content">
		    <form name="pwResetForm" autocomplete="off" id="pwResetForm" method="post" action="./pwResetAction2.jsp">
		        <ul>
		            ...
		            <li><input  maxlength="30" type="text" name="user_pw" id="user_pw" placeholder="새로운 비밀번호를 입력하세요"></li>
		            <li><input maxlength="250" type="text" name="user_pw2" id="user_pw2" placeholder="비밀번호를 한번 더 입력하세요"></li>
		        </ul>
