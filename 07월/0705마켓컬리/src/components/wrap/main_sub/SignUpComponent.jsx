...
export default function SignUpComponent({회원가입, timer, timerCounterfn, mapAddressFn}) {
        ...
        if( regExp2.test(value)===false  || regExp3.test(value)===true || regExp4.test(value)===false  ||  regExp5.test(value)===true ){            
            ...
            .then((res)=>{
                try {
                    ...
                    if( res.data === true ){ // true이면 중복된 것임.             
                        setState({
                            ...state,
                            isIdOk: false
                        })
    ...
    const onClickChoogaIdokBtn=(e)=>{
        ...
        axios({  /* 'http://localhost:8080/kurly/idCheckAction.jsp', */
            // 추천인아이디를 보내서 비교한 결과를 반환받는다. 
            url:'/kurly/idCheckAction.jsp',
            method: 'POST',
            data: {}, 
            params: {"user_id":state.추천인아이디}
        })
        .then((res)=>{
            try {
                console.log(res);
                ...
                if( res.data === true ){ // true이면 추천인 아이디가 있다. 
                    setState({
                        ...state,
                        isIdOk: false
                    })
                    ...
                    <div className="container">
                        <div className="gap">
                            ...
                            <div className="content">
                                <form autoComplete='off' onSubmit={onSubmitSignupEvent} name='sign_up_form' id='signUpForm' method='post' action="">
                                    <ul>
                                        <li>
                                            <div>
                                            ...
                                            <div>
                                                ...
                                                <div className="center-box">
                                                    ...
                                                    <input 
                                                        ...
                                                        type='text' 
                                                        className={`${addr.isAddr?'on':''}`} 
                                                        name='user_addr' id='userAddress2' 
                                                        placeholder='나머지 주소2' 
                                                        value={addr.주소2} 
                                                    />
                                                    <h5>샛별배송</h5>
