...
export default function WrapComponent() {
    ...
    return (
        <div id='wrap'>
            <GlobalContext.Provider value={{ CARTPRODUCTKEY, VIEWPRODUCTKEY, TOPMODALKEY, ADDRESSKEY, isAdmin, mainModalShowOut, mainModalOneYearShowOut, addressAuto, postCodeClose, openPopupDaumPostApi,addr, setAddr, login, setLogin, signin, setSignin}}>
